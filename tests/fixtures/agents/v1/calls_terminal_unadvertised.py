...
`terminal/create`'s params schema requires `sessionId` and `command`; `command` is a harmless
placeholder since the mock client only ever answers `-32601` in this scenario.
"""
