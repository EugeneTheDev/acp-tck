...
Backed by the vendored `schema/v1/schema.json` (see `tck/schema/v1/VENDORED.md`). The schema's
top-level shape is `anyOf` of three side-annotated envelopes -- `Agent`, `Client`,
