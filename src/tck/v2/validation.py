...
`find_unknown_root_keys`) but is its own module, not shared code
(`.agents/research/common-v1-v2-split-analysis.md` D6) -- v2 differs from v1 in three ways this
module encodes (`.agents/research/acp-v2-patches-enums-extensibility.md`, "v2 validator
checklist"):
