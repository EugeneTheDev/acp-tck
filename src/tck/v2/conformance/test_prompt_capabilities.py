...
@pytest.mark.capability("capabilities.session.prompt.image")
...
@pytest.mark.capability("capabilities.session.prompt.audio")
...
@pytest.mark.capability("capabilities.session.prompt.embeddedContext")
